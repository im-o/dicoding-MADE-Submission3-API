...
public class MovieItems implements Parcelable {
    ...
    public MovieItems(String title, String original_title, String release_date, Double vote_average, String vote_count, String overview, String poster_path, String backdrop_path) {
        this.title = title;
